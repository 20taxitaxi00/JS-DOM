...
q7.addEventListener("mouseover",function (event){
	q7.style.color = "white";
...
q8.addEventListener("mouseover",function (event){
	q8.style.color = "white";
	q8.style.backgroundColor = "black";
}
	)
q8.addEventListener("mouseout",function (event){
	q8.style.color = "black";
...
console.log(q15btn[1].textContent);
console.log(q15btn[2].textContent);
